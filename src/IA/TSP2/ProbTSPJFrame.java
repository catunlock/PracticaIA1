 ...
 * @author  javier
 */
public class ProbTSPJFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        hillClimbTA = new TSPDrawPanel();
        Inicial = new TSPDrawPanel();
